    ...
    <div class="p-5 flex flex-col flex-1">
        ...
        <div class="mb-5">
            <div class="flex justify-between items-end mb-1">
                ...
                <span class="text-xs font-bold text-accent">{{ $quota_total - $quota_used }} Kursi</span>
            </div>
            <div class="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-2">
                <div class="bg-accent h-2 rounded-full" style="width: {{ ($quota_used / $quota_total * 100) }}%"></div>
            </div>
